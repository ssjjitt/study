...
async function runUITest() {
    ...
    try {
        ...
        try {
            let loginButton = await driver.wait(until.elementLocated(By.css('[data-testid="login-button"]')), 10000);
            ...
            console.log('Найден элемент по css: ' + await loginButton.getText());
        } catch (e) {
            console.log('Элемент по css не найден');
        }
